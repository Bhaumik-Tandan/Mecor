...
class IntelligentValidationAgent:
    ...
    def validate_candidates(
        ...
        # Use GPT to validate candidate quality
    ...
    def _analyze_candidate_quality(
        ...
        # Analyze top 5 candidates for efficiency
    ...
    def _execute_search_with_strategy(
        ...
        if iteration == 0:
            # First attempt: Use hybrid search
            strategy = SearchStrategy.HYBRID
        elif iteration == 1:
            # Second attempt: Try vector-only for broader results
            strategy = SearchStrategy.VECTOR_ONLY
            query.max_candidates = min(50, query.max_candidates * 2)
        else:
            # Final attempt: BM25 for keyword precision
